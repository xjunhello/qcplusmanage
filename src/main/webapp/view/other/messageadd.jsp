...
<body>
	...
	<div class="modal-body">
		<div class="ibox-content">
			<form method="post" id="addform" action="message/add"
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input class="form-control" id="fromUser"
						name="fromUser" placeholder='请输入'>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-6">
						<input class="form-control" id="toUser"
						name="toUser" placeholder='请输入'>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-6">
						...
						name="content" placeholder='请输入'></textarea>
					</div>
				</div>
				<div class="hr-line-dashed"></div>
				<div class="form-group">
