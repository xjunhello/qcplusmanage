...
<body>
	...
	<div id="wrapper">
		<jsp:include page="/view/public/menu.jsp">
			<jsp:param name="activeOne" value="hotlist"/>
		</jsp:include>
		<div id="page-wrapper" class="gray-bg">
			...
			<div class="row wrapper border-bottom white-bg page-heading">
				<div class="col-sm-10">
					...
					<ol class="breadcrumb">
						<li><a>热点管理</a></li>
						<li class="active"><strong>热点管理</strong></li>
					</ol>
				</div>
											...
											<c:forEach items="${page.list}" var="entity">
												<tr class="gradeX">
													...
													<td class="text-center">
														 <a class="btn btn-xs btn-info detailbtnclass" value="${entity.id }"> 详情</a>
														 <a class="btn btn-xs btn-warning updatebtnclass" value="${entity.id }"> 修改</a>
