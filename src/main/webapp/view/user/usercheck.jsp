...
<body>
	<div class="modal-header">
		...
		<h3 class="modal-title" id="myModalLabel">详细信息审核</h3>
	</div>
	<span id="error"></span>
	...
	<div class="modal-body">
		<div class="ibox-content">
			...
			<c:if test="${user.logtype eq 1 or user.logtype eq 3 or user.logtype eq 4 }">
				...
				<div class="form-group">
					<label for="sender_cardphoto" class="col-sm-4"> 企业证件照
					</label>
					<div class="col-sm-6 "><span >${sender.cardphoto}</span></div>
				</div>
			</c:if>
			...
			<div class="form-group">
				<div class="col-sm-8 col-sm-offset-4">
					<button id="checkPassBtn" class="btn btn-success " type="button">审核通过</button>&nbsp;
					<button id="checkUnPassBtn" class="btn btn-primary" type="button">审核不通过</button>
				</div>
			</div>
		</form>
		</div>
