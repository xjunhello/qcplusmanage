...
(function() {
	...
	var LobiboxBase = {
		...
		_onButtonClick: function(buttonOptions, type) {
			var me = this;
			if ((type === 'ok' && me.$type === 'prompt' && me.isValid() || me.$type !== 'prompt' || type !== 'ok') && buttonOptions && buttonOptions.closeOnClick) {
				me.destroy()
			}
		},
	...
	Lobibox.base.OPTIONS = {
		...
		icons: {
			bootstrap: {
				confirm: 'glyphicon glyphicon-info-sign',
...
(function() {
	var LobiboxNotify = function(type, options) {
			...
			var _createNotifyWrapper = function() {
					var selector = (me.$options.size === 'large' ? '.lobibox-notify-wrapper-large' : '.lobibox-notify-wrapper') + "." + me.$options.position.replace(/\s/gi, '.'),
						$wrapper;
					$wrapper = $(selector);
					if ($wrapper.length === 0) {
