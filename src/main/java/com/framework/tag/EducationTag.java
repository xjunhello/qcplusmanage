...
public class EducationTag extends TagSupport {
	/**
	 * 
	 */
	private static final long serialVersionUID = 3243645301880995588L;
	private static List<Dicattreducation> educationList=DicHelper.getEducationList();
	@Override
	...
	public int doStartTag() throws JspException {
		...
		try {
            ...
            out.println(">");
            for(Dicattreducation s :educationList){
