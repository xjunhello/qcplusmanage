...
public class CompanySizeTag extends TagSupport {
	/**
	 * 
	 */
	private static final long serialVersionUID = 3243645301880995588L;
	private static   List<Diccompanysize> getDiccompanysizeList=DicHelper.getCompanysizeList();
	@Override
	...
	public int doStartTag() throws JspException {
		...
		try {
            ...
            if(getDiccompanysizeList == null || getDiccompanysizeList.size()==0) {
                out.println("公司规模初始化失败");
                return SKIP_BODY;
            }
            out.println("<select ");
            ...
            out.println(">");
            for(Diccompanysize s : getDiccompanysizeList){
