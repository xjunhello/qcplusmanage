...
public class ServiceProviderTypeTag extends TagSupport {
	/**
	 * 
	 */
	...
	private static List<DicServiceProviderType> serviceProviderTypeList
		= DicHelper.getServiceProviderTypeList();
	@Override
	...
	public int doStartTag() throws JspException {
		...
		try {
            ...
            if(serviceProviderTypeList == null || serviceProviderTypeList.size()==0) {
                out.println("服务商类型初始化失败");
                return SKIP_BODY;
            }
            out.println("<select ");
            ...
            out.println(">");
            for(DicServiceProviderType s : serviceProviderTypeList){
	...
	public static void setServiceProviderTypeList(
		...
		ServiceProviderTypeTag.serviceProviderTypeList = serviceProviderTypeList;
	}
