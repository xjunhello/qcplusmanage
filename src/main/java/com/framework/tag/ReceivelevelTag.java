...
public class ReceivelevelTag extends TagSupport {
	...
	public int doStartTag() throws JspException {
		...
		try {
            ...
            if(receivelevelList == null || receivelevelList.size()==0) {
                out.println("用户等级初始化失败");
                return SKIP_BODY;
            }
            out.println("<select ");
            ...
            out.println(">");
            for(Dicreceivelevel s : receivelevelList){
